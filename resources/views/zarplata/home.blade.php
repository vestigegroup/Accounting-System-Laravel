...
<div class="modal fade" id="addzarplata" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <form class="form-horizontal" action="{{ URL::to($project_id.'/rasxodi/zarplata/addzarplata') }}"  method="POST" id="multiple" enctype="multipart/form-data">
        {{ csrf_field() }}
...
<div class="modal fade" id="editzarplatamodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <form class="form-horizontal" action="{{ route('zarplatas.edit') }}"  method="POST" id="multiple" enctype="multipart/form-data">
        {{ csrf_field() }}
...
// Delete task and remove it from list
    ...
    $('.deletezarplata').click(function(){
        ...
        $('.deletebtn').click(function(){
            $.ajax({
                type: "get",
                url:"/rasxodi/zarplata/delete/" + task_id,
