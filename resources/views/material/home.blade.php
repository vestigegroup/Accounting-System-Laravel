...
<div class="modal fade" id="addzarplata" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <form class="form-horizontal" action="{{ URL::to($project_id.'/rasxodi/materials/addmaterial') }}"  method="POST" id="multiple" enctype="multipart/form-data">
        {{ csrf_field() }}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group has-error">
                         ...
                         <div class="form-group has-error">
                            <label for="inputPassword3" class="col-sm-3  text-right control-label">Ед.Измер:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Ед.Измер" required name="chenak">
                            </div>
                        </div>
                        <div class="form-group has-error">
                            <label for="inputPassword3" class="col-sm-3  text-right control-label">Всего:</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" placeholder="Всего" required name="mikdor">
                            </div>
                        </div>
                        <div class="form-group has-error">
                            <label for="inputPassword3" class="col-sm-3  text-right control-label">Цена:</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" placeholder="Цена" required name="narx">
                            </div>
                        </div>
                        <div class="form-group has-error">
...
<div class="modal fade" id="editzarplatamodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <form class="form-horizontal" action="{{ route('materials.editmaterials') }}"  method="POST" id="multiple" enctype="multipart/form-data">
        {{ csrf_field() }}
...
// Delete task and remove it from list
    ...
    $('.deletezarplata').click(function(){
        ...
        $('.deletebtn').click(function(){
            $.ajax({
                type: "get",
                url:"/rasxodi/materials/delete/" + task_id,
