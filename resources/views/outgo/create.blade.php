                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputAmount" placeholder="Исполнителние" autocomplete="false" autofocus="false" name="ispolnitelni">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="exampleInputAmount" placeholder="Сумма" name="summa">
                            ...
                            <table class="table  table-condensed ">
                                ...
                                <tbody class="table-hover">
                                    <tr id="row_1" class="">
                                        ...
                                        <td>
                                            <input type="number" class="form-control" placeholder="Кол-во" aria-describedby="basic-addon1" name="kol_vo" >
                                        </td>
                                        <td>
