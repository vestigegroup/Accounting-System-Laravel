        ...
        <div class="">
            ...
            <div class="col-xs-12 col-sm-8 col-md-9 col-lg-10 rasxod-menu-spisokall">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" style="margin: 0px;">
                   ...
                   <form class="" method="post" data-parsley-validate id="update-prixodi" action="{{ route('income.update', [ 'id' => $income->id ]) }}">
                        ...
                        <div class="tab-content" style="padding: 10px;border: 1px solid #ddd">
                            <div id="home" class="tab-pane fade in active">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Имя Клиента" aria-describedby="basic-addon1" name="customer_name" required value="{{ $income->customer_name }}">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Називание Фирма" aria-describedby="basic-addon1" name="company_name" required value="{{ $income->company_name }}">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <select class="form-control" name="type_of_zakaz">
                                                <option>{{ $income->type_of_zakaz }}</option>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Флайер, Брошурка, Буклет, и тд...  " aria-describedby="basic-addon1" name="zakaz" required value="{{ $income->zakaz }}">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Количество " aria-describedby="basic-addon1" name="kolvo" required value="{{ $income->kolvo }}">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="number" class="form-control" placeholder="сомони" aria-describedby="basic-addon1" name="stoimost_zakaz" id="stoimost_zakaz" required value="{{ $income->stoimost_zakaz }}">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input min="0" max="100" maxlength="3" type="text" class="form-control" placeholder="%" aria-describedby="basic-addon1" name="sena_zakaz" id="sena_zakaz" required value="{{ $income->sena_zakaz }}">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control " placeholder="сомони" aria-describedby="basic-addon1" name="obshiye_summa" id="obshiye_summa" readonly value="{{ $income->obshiye_summa }}">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group ">
                                            <input type="text" class="form-control" placeholder="сомони" aria-describedby="basic-addon1" name="oplachno" id="oplachno" required value="{{ $income->oplachno }}">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="сомони" aria-describedby="basic-addon1" name="ostotok" id="ostotok" readonly value="{{ $income->ostotok }}">
