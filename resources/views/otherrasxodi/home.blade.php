...
<div class="modal fade" id="addzarplata" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <form class="form-horizontal" action="{{ URL::to($project_id.'/rasxodi/otherrasxodi/addotherrasxodi') }}"  method="POST" id="multiple" enctype="multipart/form-data">
        {{ csrf_field() }}
...
<div class="modal fade" id="editzarplatamodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <form class="form-horizontal" action="{{ route('otherrasxodis.editotherrasxodis') }}"  method="POST" id="multiple" enctype="multipart/form-data">
        {{ csrf_field() }}
