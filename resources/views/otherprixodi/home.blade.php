...
@include('shared.topnavigationprixodi')
@include('shared.mainmenuprixodi')
<!-- Modal for Add Prixodi -->
<div class="modal fade" id="addzarplata" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <form class="form-horizontal" action="{{ route('otherprixodi.addotherprixodi') }}"  method="POST" id="multiple" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <div class="form-group has-prixod">
                        ...
                        <div class="form-group has-prixod">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" placeholder="Сумма" required name="summa">
                            </div>
                        </div>
                        <div class="form-group has-prixod">
                        ...
                        <div class="form-group has-prixod">
                            ...
                            <div class="col-sm-9">
                                    <label for="files" class="btn btn-info-custom btn-block btn-outlined"><i class="fa fa-plus"> Select files</i></label>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-info-custom" type="submit">Сохранить</button>
                </div>
            </div>
        </div>
    </form>
...
<div class="modal fade" id="editzarplatamodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <form class="form-horizontal" action="{{ route('prixodi.editprixodi') }}"  method="POST" id="multiple" enctype="multipart/form-data">
        {{ csrf_field() }}
