                    ...
                    <div class="well">
                        <div class="media">
                            <div class="media-left">
                                <a href="#">
                                    <img class="media-object" src="{{url('')}}/{{ $sotrudniki->photo_path }}" width="200px" height="200px">
                                </a>
                            </div>
                            <div class="media-body">
                                ...
                                <div class="col-md-12 list-group-item">
                                    ...
                                    <div class="col-md-6">
                                        {{ $sotrudniki->data_rojdeniya }}
                                        <i class="fa fa-calendar fa-fw pull-right" style="color: #6d2890 !important;"></i>
                                    </div>
                                </div>
                                <div class="col-md-12 list-group-item">
                                    <div class="col-md-6 text-right">
                                    ...
                                    <div class="col-md-6">
                                        {{ $sotrudniki->mesto_rojdeniy }}
                                        <i class="fa fa-building fa-fw pull-right" style="color: #6d2890 !important;"></i>
                                    </div>
                                </div>
                                <div class="col-md-12 list-group-item">
                                    <div class="col-md-6 text-right">
                                ...
                                <div class="col-md-12 list-group-item">
                                    ...
                                    <div class="col-md-6">
                                        {{ $sotrudniki->doljnost }}
                                        <i class="fa fa-book fa-fw pull-right" style="color: #6d2890 !important;"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
